    ...
    const crearAlojamientos = async () => {
        ...
        if (result.isConfirmed) {
            ...
            try {
                ...
                formData.append("name", alojamiento.name)
                formData.append("tipo", alojamiento.tipo)
                formData.append("precio", alojamiento.precio)
                formData.append("ciudad", alojamiento.ciudad)
                formData.append("image", alojamiento.fichero)
                const fetched = await CrearAlojamiento(formData, token);
        ...
        <>
            <div className="gestioVuelos-design">
                ...
                <div className="content-alojamiento">
                    ...
                    <div className="tabla-alojamiento" encType="multipart/form-data">
                        {
